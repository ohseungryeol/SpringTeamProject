<template>
    <div v-if="article!=null">
        ...
        <div v-if="myInfo.isConfirmed" class="mt-3" style="text-align:center">
            <p class="finParty"> DONE </p>
        </div>
        <b-container style="margin-top: 30px; margin-bottom: 30px;" fluid="sm" v-if="memberInfo != null">
            <b-row>
        ...
        <div style="margin-bottom: 40px;" class="box mt-3 p-5">
            <div>
                <carousel 
                    :perPage="1" 
                    ...
                    <slide v-for="(item, index) in party" :key="index">
                        <div>
                            <div style ="margin-bottom: 30px; " v-if="item.isBoss==true"><h5>파티장</h5></div>
                            <div style ="margin-bottom: 30px; " v-if="item.isBoss==false"><h5>파티원</h5></div>
                            <MyProfile :userId="item.profileId" style="color:black;"></MyProfile>
                            <br>
                            <b-button style="margin-top: 30px;" variant="outline-success" @click="moveToMysaza(item)">정보보기</b-button>
                        </div>
                    </slide>
                </carousel>
            </div>
            <!-- {{id}}<br> -->
            <b-container style="margin-top: 30px;" fluid="sm" v-if="memberInfo != null">
                <b-row>
