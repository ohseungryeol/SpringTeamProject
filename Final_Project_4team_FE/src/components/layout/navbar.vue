<template>
    <div>
      ...
      <div class="row-vw d-flex">
        <div class="item"></div>
        <div class="item mx-auto mr-100"  >

          <b-navbar-nav>
            <b-button pill style="background-color: white; border: 0; color: black; border-radius: 0; font-size: 30px; font-weight: bold;" @click="toHome">DIB</b-button>
        ...
        <div class="item">
          ...
          <div v-if="accesstoken == null">
            <b-button pill style="background-color:white;border:0;color: black" @click="$bvModal.show('signlogin')"> SIGN</b-button>  &nbsp; &nbsp;
            ...
            <b-nav-item-dropdown right>
              <template #button-content>
                <em>
                  ...
                  <img src="@/assets/loging.jpeg" style="width:40px">
                </em>
              </template>
              <b-dropdown-item router-link to="/admin" v-if="user != null && user.isAdmin">관리자</b-dropdown-item>
              <b-dropdown-item router-link to="/mypage">마이 페이지</b-dropdown-item>
      ...
      <div>
            <div>
                <b-nav align="center" >
                    <b-nav-item router-link to="/" :active="homeActive" @click="getHomeActive">서비스 소개</b-nav-item>
                    <b-nav-item router-link to="/board" :active="thisSazaActive" @click="getThisSazaActive">메인 페이지</b-nav-item>
                    <b-nav-item router-link :to="mysazaUrl" :active="mySazaActive" @click="getMySazaActive">마이 페이지</b-nav-item>
    ...
    data() {
        return {
            ...
            data:{
                    ...
                    client_id : "9a3bc8a10878ba7817c8f9a7c9c7b998",
        ...
        getKakaoToken(){
            ...
            if(this.queryString!=null){
                axios({
                    ...
                    headers : {
                        "Authorization":"2dee289d17522ab0d82e9f26cebd661e",
                    ...
                    window.Kakao.API.request({
                        ...
                        success: function(data) {
                            ...
                            axios({
                                method : "post",
                                url : "http://13.125.187.89:8080/user/login",
                                data : {
                                    authid : data.id,
                                },
                            }).then(({data})=>{
...
.row-vw {
  ...
  margin-bottom: 20px; /* 아래 여백 0 */
  margin-top: 25px; /* 위 여백 20px */
}
