  ...
  <div>
    <b-container>
      ...
      <div class="mt-4">
        ...
        <b-button variant="warning1" @click="execDaumPostcode" class="ml-3" style="width:20%;display:inline">찾기</b-button>
        ...
        <div style="text-align:center">
          <div class="photo" style="display:inline-block">
            <div v-if="preImage==null">
              <br><br>
              <img  src="@/assets/loging.png" style="width: 100%; height: 100%;" alt="">
            </div>
            <div v-if="preImage!=null">
              <br>
              <br>
