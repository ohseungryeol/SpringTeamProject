                ...
                <b-col cols="4">
                    <div style="cursor:pointer">
                        ...
                        <b-card
                            ...
                            overlay
                            @click="moveToDetail"
                            :img-src="this.article.pic[0]"
                        >
                        <b-button v-if="finDeal" variant="danger" size="sm" disaled>모집 완료</b-button>
                            ...
                            <b-row>
                                ...
                                <b-col>
                                    <div style="text-align:right" class="mt-5">
                                        ...
                                        <div v-if="isZzim"><img src="@/assets/zzimOn.png" style="width:70px;cursor:pointer" @click="deleteZZim"></div>
                                        <div v-if="!isZzim"><img src="@/assets/zzimOff.png" style="width:70px;cursor:pointer" @click="addZZim"></div>
