<template>
  <div class="home mt-3" style="text-align : center">
    <div style="background-color : #F5E232; width:100%">
      <div class="py-5 container">
        <b-container>
          <b-row align-v="center" class="my-5">
            <b-col cols="7">
              <img src="@/assets/loging.png" style="width:50%; backgroun-size : cover">
            </b-col>
            <b-col >
              ...
              <button :class="{p_button:true}" @click="moveToGuide" style="font-size:1.5vw">띱</button>
            </b-col>
          </b-row>
        </b-container>
      </div>
...
<!--    <div>-->
<!--      <div class="py-5 container">-->
<!--        <h3 style="font-size:2vw">파티참여</h3>-->
<!--      </div>-->
<!--    </div>-->
