<template>
  <div style="display:inline-block" v-if="profile != null">
    <div class="card mb-3 flex-row" style=" color: #F5E22F; font-size:1em;align-items:center; background-color:#202838; width:400px; padding-left:30px ;padding-right: 30px;padding-top: 10px;padding-bottom: 10px;" >
      <img v-if="profile.pic==null" src="@/assets/loging.png" style="width:80px;height:80px;background-color:#202838" alt="Card image" class="card-img-left p-1 ml-3">
