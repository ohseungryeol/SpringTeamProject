    ...
    <div  v-if="article != null">
        ...
        <div class="mt-2">
            <b-row>
                ...
                <b-col>
                    <div style="background-color:#F5E232;border-radius:0.3em;text-align:right;">
                        <img v-if="isZzim" src="@/assets/zzimOn.png" style="width:70px;cursor:pointer" @click="deleteZZim">
                        <img v-if="!isZzim" src="@/assets/zzimOff.png" style="width:70px;cursor:pointer" @click="addZZim">&nbsp;
                        <div class="p-2">
                            <!-- 기간이 안나와요 -->
        ...
        <div class="mt-3">
                ...
                <div v-for="(comment, index) in commentList" :key="index">
                    ...
                    <div  style="margin-right:15px; margin-left:15px">
                        ...
                        <b-collapse :id="String(comment.id)" class="mt-2">
                            <div class="p-2" style="border-radius: 2em;">
                                ...
                                <b-button style="display:inline; width:10%;" @click="modifyComment(comment)">등록</b-button>
                            </div>
                        </b-collapse>
                    ...
                    <div >
                        <b-row>
                            ...
                            <b-col cols="3" style="font-size:12px; text-align: center;">{{comment.createdAt[0]}}.{{comment.createdAt[1]}}.{{comment.createdAt[2]}} {{comment.createdAt[3]}}:{{comment.createdAt[4]}}</b-col>
                        </b-row>
                    </div>
                    <hr>
                </div>
            ...
            <div class="p-2" style="border-radius: 2em;" v-if="!finDeal">
                ...
                <b-form-textarea placeholder="댓글을 입력하세요." size="sm" class="mr-1" style="display:inline;width:80%" v-model="comment"></b-form-textarea>
